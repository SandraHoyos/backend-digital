    ...
    (function(){
      ...
      //recorremos la colección de peliculas del JSON
         for(odontologo of data){
            ...
            var odontologo =table.insertRow();
           ...
           odontologo.innerHTML = '<td>' + updateButton + '</td>' +
                    '<td class=\"td_titulo\">' + odontologo.titulo.toUpperCase() + '</td>' +
                    '<td class=\"td_categoria\">' + odontologo.categoria.toUpperCase() + '</td>' +
                    '<td>' + deleteButton + '</td>';
