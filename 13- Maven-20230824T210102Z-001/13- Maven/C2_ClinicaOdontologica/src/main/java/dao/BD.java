...
public class BD {
    ...
    private static final String SQL_DROP_CREATE_ODONTOLOGOS="DROP TABLE IF EXITS ODONTOLOGOS; CREATE TABLE ODONTOLOGOS " +
    ...
    private static final String SQL_INSERT=" INSERT INTO PACIENTES (NOMBRE, APELLIDO, CEDULA, FECHA_INGRESO, DOMICILIO_ID) " +
            "('Ever','Ludueña','122334','2023-08-09','1'),('Evo','Morales','222222','2023-08-09','2'); " +
            "INSERT INTO DOMICILIOS (CALLE, NUMERO, LOCALIDAD, PROVINCIA),('Siempre Viva','748','Springfield','USA'),('Cochabamba','748','Santa Cruz','Bolivia')";
